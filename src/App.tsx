...
> = {
  'Ship it': {
    icon: '🚀',
    className:
      'border-[#2ecc71]/55 bg-[#2ecc71]/8 text-[#2ecc71]',
  },
  'Fix this first': {
    icon: '⚠️',
    className:
      'border-[#f5c842]/55 bg-[#f5c842]/8 text-[#f5c842]',
  },
  'Burn it down': {
    icon: '🔥',
    className:
      'border-[#ff4757]/55 bg-[#ff4757]/8 text-[#ff4757]',
  },
}
      ...
      <section className="relative z-10 mx-auto flex min-h-screen w-full max-w-6xl flex-col justify-start px-6 py-16 sm:px-8 sm:py-20 lg:px-10">
        ...
        {result && verdictStyle && scoreAppearance ? (
          <div ref={resultsRef} className="mt-12 space-y-6">
            <div
              className="editorial-surface relative overflow-hidden rounded-[24px] px-6 py-8 text-center sm:px-8 sm:py-10"
            >
